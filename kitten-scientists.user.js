...
var run = function() {
    ...
    Engine.prototype = {
        ...
        _worship: function (builds) {
            ...
            let unlocked = (game.religion.faith > solarMeta.faith && faithMeta.maxValue > 750 && faithMeta.value < 750 * leaderRatio );
            let trigger = (!solarMeta.on && unlocked) ? 1 : options.auto.faith.trigger;
